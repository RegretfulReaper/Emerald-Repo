...
const GUARD_SPAWN = [
    ...
    { map: 0, x: 2279.651367, y: -5262.148926, z: 80.867188, o: 0.055122 },
    { map: 0, x: 2281.300781, y: -5254.396484, z: 80.314240, o: 5.081670 },
    { map: 0, x: 2274.661865, y: -5259.040527, z: 83.352425, o: 0.831882 },
    { map: 0, x: 2271.162842, y: -5259.281738, z: 83.355011, o: 4.788717 },
    { map: 0, x: 2275.503662, y: -5248.169434, z: 83.408035, o: 5.761824 },
    { map: 0, x: 2271.187256, y: -5244.359375, z: 83.349091, o: 4.773009 },
    { map: 0, x: 2267.567871, y: -5244.428711, z: 83.345581, o: 4.824060 },
    { map: 0, x: 2271.744873, y: -5236.509277, z: 90.429802, o: 3.579204 },
    { map: 0, x: 2267.489014, y: -5232.777832, z: 90.535423, o: 0.889999 },
    { map: 0, x: 2259.961670, y: -5245.785156, z: 90.397362, o: 4.652058 },
    { map: 0, x: 2247.683350, y: -5246.468262, z: 90.396637, o: 4.729813 },
    { map: 0, x: 2318.791016, y: -5277.560547, z: 82.036667, o: 5.301580 },
    { map: 0, x: 2328.095703, y: -5268.896484, z: 82.310982, o: 5.589821 },

]


// console.log(std.CreatureTemplates.load(16378).objectify())
...
const natham = std.CreatureOutfits.create().fromString(`
Character\Human\male\humanmale.m2
1 0
14 0 2 7 0 2 16777215
39723
0
40334
45559
...
std.CreatureTemplates.create('mod', 'nat-ham')
    .Name.set({"enGB":"Nathaniel Hammerfall"})
    .Level.set(80, 80)
    .Models.addIds(natham.ID)
    .Rank.ELITE.set()
    .Spawns.add('mod', 'natham', {map:0,x:2266.795410,y:-5259.507812,z:83.361115,o:0.854652},)
    .Questgiver.addBoth(26103)
    .FactionTemplate.set(794)
