...
std.Items.create('mod', 'blessed-prophecy-head')
...
std.Items.create('mod', 'blessed-prophecy-shoulders')
...
std.Items.create('mod', 'blessed-prophecy-chest')
...
std.Items.create('mod', 'blessed-prophecy-wrists')
...
std.Items.create('mod', 'blessed-prophecy-hands')
...
std.Items.create('mod', 'blessed-prophecy-waist')
...
std.Items.create('mod', 'blessed-prophecy-legs')
...
std.Items.create('mod', 'blessed-prophecy-feet')
...
std.Items.create('mod', 'Blessed-Cloak-of-Grace')
...
std.ItemSet.create('mod', 'Prophecy-Heirloom')
...
std.Items.create('mod', 'blessed-light-binder-staff')
