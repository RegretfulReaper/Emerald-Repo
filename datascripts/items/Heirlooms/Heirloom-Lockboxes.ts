...
std.Items.create('mod', 'mighty-lockbox')
    ...
    .Material.METAL.set()
    .Quality.PURPLE.set()
    .Flags.set(["OPENABLE", "HEROIC", "REFUNDABLE"])
    .ItemLevel.set(265)
...
std.Items.create('mod', 'Blemished-Lockbox')
...
std.Items.create('mod', 'Enchanted-Lockbox')
...
std.Items.create('mod', 'Torn-Lockbox')
...
std.Items.create('mod', 'Felheart-Lockbox')
...
std.Items.create('mod', 'Prophecy-Lockbox')
...
std.Items.create('mod', 'Dragonstalker-Lockbox')
...
std.Items.create('mod', 'TenStorms-Lockbox')
...
std.Items.create('mod', 'Cenarion-Lockbox')
