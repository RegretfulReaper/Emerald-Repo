...
export const Might_Helm = std.Items.create('mod', 'heirloom-might-helm')
...
export const Might_Shoulder = std.Items.create('mod', 'heirloom-might-shoulder')
...
export const Might_Chest = std.Items.create('mod', 'heirloom-might-chest')
...
export const Might_Wrist = std.Items.create('mod', 'heirloom-might-wrist')
...
export const Might_Hands = std.Items.create('mod', 'heirloom-might-hand')
...
export const Might_Belt = std.Items.create('mod', 'heirloom-might-waist')
...
export const Might_Legs = std.Items.create('mod', 'heirloom-might-legs')
...
export const Might_Boots = std.Items.create('mod', 'heirloom-might-feet')
...
const MIGHT_HEIRLOOM_SET = std.ItemSet.create('mod', 'Heirloom-Might-Set')
...
std.Items.create('mod', 'Heirloom-Might-Back')
    ...
    std.Spells.create('mod','change item')
    // =================================================
    //
    // - Basic Properties -
    //
...
std.Items.create('mod', 'Bloodied-Ravager', 7717)
...
std.Items.load(42943)
    .Spells.addGet()
        ...
        std.Spells.create('mod','change-back')
        // =================================================
        //
        // - Basic Properties -
        //
...
std.Items.create('mod', "Might-Shield", 10767)
