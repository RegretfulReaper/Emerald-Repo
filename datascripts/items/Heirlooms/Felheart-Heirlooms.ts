...
std.Items.create('mod', 'cursed-head')
...
std.Items.create('mod', 'cursed-shoulders')
...
std.Items.create('mod', 'cursed-chest')
...
std.Items.create('mod', 'cursed-wrists')
...
std.Items.create('mod', 'cursed-hands')
...
std.Items.create('mod', 'cursed-waist')
...
std.Items.create('mod', 'cursed-legs')
...
std.Items.create('mod', 'cursed-feet')
...
std.Items.create('mod', 'Cursed-Cloak-of-Flames')
...
std.ItemSet.create('mod', 'Felheart-Heirloom')
